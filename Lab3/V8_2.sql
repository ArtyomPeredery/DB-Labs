...
as
(select
	A.AddressID, A.AddressLine1, A.AddressLine2, A.City, A.StateProvinceID,	A.PostalCode, A.ModifiedDate,
	(select 
		AccountNumber
	from 
...
insert into dbo.#Address (
    ...
    PostalCode,	ModifiedDate, AccountNumber, MaxPrice
) select 
	AddressID,	AddressLine1, AddressLine2,	City,
     StateProvinceID, PostalCode,	ModifiedDate, AccountNumber, MaxPrice
from Address_CTE;
